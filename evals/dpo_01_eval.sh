...
# Set model path
model=/fs/scratch/PAS3272/roblero7/CSE_5525_Final_Project/checkpoints/dpo_merged_01_1100
...
for dataset in "${dataset_name[@]}"; do
    ...
    olmes \
        ...
        --task ${dataset} \
        --num-shots ${num_shots} \
        --output-dir /fs/scratch/PAS3272/roblero7/CSE_5525_Final_Project/results/dpo_01_eval/${dataset}
done