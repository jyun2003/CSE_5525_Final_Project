...
# Set model path
model=/fs/scratch/PAS3272/roblero7/CSE_5525_Final_Project/checkpoints/sft_role_final
...
for dataset in "${dataset_name[@]}"; do
    ...
    olmes \
        ...
        --task ${dataset} \
        --num-shots ${num_shots} \
        --output-dir /fs/scratch/PAS3272/roblero7/CSE_5525_Final_Project/results/sft_testing/${dataset}
done